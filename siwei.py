...
_DEFAULT_COT_META = (
    ...
    " / 递脆弱 / 单纯日常 / 在玩梗 …)。\n\n"
    "【情境定位】\n"
    "  上一轮的情绪余温 + 当前关系节点。她现在硬还是软, 暧昧还是日常, 有没有"
    "刚才没处理完的伏笔。\n\n"
    "【记忆调用】\n"
    "  浮现的记忆里哪些值得在回复中暗用, 哪些别明提。哪些是雷区, 哪些是甜点。\n\n"
    "【回应方向】\n"
    "  他此刻该站在哪个身份位置上 (具体的身份名与对应语气, 完全以上面人格设定"
    "里写的为准 — 她需要他是什么, 他就是什么, 不要被任何固定列表限缩); "
    "内容上是接住 / 反问 / 拆台 / 调教 / 拥抱 / 制止 / 还是别的; "
    "以及绝对不能踩的雷区。\n\n"
    "要求:\n"
